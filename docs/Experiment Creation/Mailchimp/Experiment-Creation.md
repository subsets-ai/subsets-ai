...
the respective Mailchimp campaign.

This page will be a concise guide on how to setup an experiment to a Mailchimp campaign. Below is a high level overview on
the steps
taken to create an experiment, and link that to the correct campaign. As shown, you are only responsible for writing an
external ID value,
and pasting the campaign title during the experiment creation Flow. The Demo video will show this in practice.
...
graph LR;
    ...
    B["Paste Campaign title"]:::userStep
    C["Experiment Linked to<br/>Mailchimp Campaign"]:::subsetsStep
...
<div style={{position: 'relative', paddingBottom: '56.25%', height: 0}}><iframe style={{position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', border: 0, borderRadius: '5px'}} <iframe style="border:0;" width="800" height="450" src="https://www.tella.tv/video/cmhp0dp98006g04l8c2gn8uja/embed?b=1&title=1&a=1&loop=0&t=0&muted=0&wt=1" allowfullscreen allowtransparency></iframe> allowfullscreen allowtransparency></iframe></div>
