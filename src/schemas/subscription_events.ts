...
export const subscriptionEventsSchema = {
  subscription_events: {
    ...
    fields: [
      ...
      { name: "event_order", type: "INT64", description: "Deterministic position of this event within the subscription's timeline" },
      { name: "plan", type: "STRING", description: "Subscription plan name at event time" },
      { name: "price", type: "FLOAT64", description: "Price per term at event time" },
      { name: "term_length", type: "INT64", description: "Number of term units per billing cycle (e.g., 1 for monthly, 13 for 13-week, 12 for annual)" },
      { name: "term_unit", type: "STRING", description: "Unit of the billing cycle: day, week, or month" },
